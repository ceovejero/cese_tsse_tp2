...
void test_todos_los_leds_inician_apagados(void) {
    ...
    UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((0x00)),
                           (UNITY_INT)(UNITY_UINT16)((leds_virtuales)),
                           (
...
void test_prender_un_led(void) {
    ...
    UnityAssertBits((UNITY_INT)(((UNITY_UINT)1 << (3 - 1))), (UNITY_INT)((UNITY_UINT)(-1)),
                    (UNITY_INT)((leds_virtuales)),
                    (
    ...
    UnityAssertBits((UNITY_INT)((~(1 << (3 - 1)))), (UNITY_INT)((UNITY_UINT)(0)),
                    (UNITY_INT)((leds_virtuales)),
                    (
...
void test_consultar_estado_de_led(void) {
    ...
    do {
        if ((leds_get_status(5))) {
        } else {
            UnityFail(((" Expected TRUE Was FALSE")), (UNITY_UINT)((UNITY_UINT)(108)));
        }
    } while (0);
}
...
void test_encender_todos_y_verificar_todos_encendidos(void) {
    ...
    leds_turn_on_all(), UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((0xFF)),
                                               (UNITY_INT)(UNITY_UINT16)((leds_virtuales)),
                                               (
...
void test_apagar_todos_y_verificar_todos_apagados(void) {
    ...
    leds_turn_off_all(), UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((0x00)),
                                                (UNITY_INT)(UNITY_UINT16)((leds_virtuales)),
                                                (
